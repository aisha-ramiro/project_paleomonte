  ...
  return {
    ...
    translations: {
      en: row.translations?.en ? {
        commonName: row.translations.en.commonName,
        category: row.translations.en.category,
        summary: row.translations.en.summary,
        description: row.translations.en.description,
        period: row.translations.en.period,
        era: row.translations.en.era,
        location: row.translations.en.location,
        discoveredBy: row.translations.en.discoveredBy,
        type: row.translations.en.type,
        diet: row.translations.en.diet,
        additionalInfo: row.translations.en.additionalInfo,
      } : {},
    },

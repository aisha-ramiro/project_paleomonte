...
export const copy = {
  ...
  es: {
    ...
    accessibility: { eyebrow: 'Para todas las personas', title: 'Accesibilidad', intro: 'PaleoMonte fue diseñado para ofrecer una navegación simple, legible y acogedora durante la visita al museo.', increase: 'Aumentar texto', normal: 'Tamaño predeterminado', contrast: 'Alto contraste', cards: [['Navegación por teclado', 'Todos los elementos interactivos se pueden acceder con el teclado.'], ['Contenido de audio', 'Las especies incluyen controles para escuchar sus descripciones.'], ['Lectura clara', 'Tipografía legible, contraste adecuado y estructura semántica.']] },
  },
};
